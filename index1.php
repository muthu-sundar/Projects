...
<body>
	...
	<header id="header">
		...
		<nav id="myTopNav" class="navtoggle">
			<ul class="header_list">
				<li class="active"><a href="http://localhost/PROJECT/PROJECT/itp/itp/index1.php">HOME</a></li>
	...
	<section id="hero-image">
		<div class="hero-text">
			<h2 id="project_title">General Online Supermarket Stock Data Management System</h2>
		</div>
...
if(isset($_POST['email'])) {
    ...
    $email_to = "muthu8124191925@gmail.com";
